...
const CheckboxSetting = ({ name, checked, label, tooltip }) => {
  ...
  return (
    <label>
      ...
      <span className={`label ${tooltip ? "tooltip" : ""}`}>
        {label}
        {tooltip && <span className="tooltip__content">{tooltip}</span>}
      </span>
    </label>
  );
};
...
class Settings extends React.Component {
  ...
  componentDidUpdate = () => {
    ...
    if (
      ...
      input_in_focus !== "pusher_username"
    ) {
  ...
  renderLocalScanButton = () => {
    ...
    const loading =
      processes.local_scan && processes.local_scan.status === "running";
  ...
  render = () => {
    const {
      mopidyActions: { set: setMopidy },
      mopidy,
      pusherActions: { setUsername, runCommand, setCommands },
      pusher,
      history,
      uiActions,
      ui,
    } = this.props;
    const { pusher_username } = this.state;

    const options = (
      <>
        <Button discrete noHover to="/settings/debug">
          <I18n path="debug.title">
            <Icon name="code" />
          </I18n>
        </Button>
        <Button
          href="https://soundfood.it"
          target="_blank"
      ...
      <div className="view settings-view">
        ...
        <section className="content-wrapper">
          ...
          <div className="field dropdown">
            <div className="name">
              <I18n path="settings.interface.language.label" />
            </div>
            <div className="input">
              <SelectField
          ...
          <div className="field checkbox">
            <div className="name">
              <I18n path="settings.interface.behavior.label" />
            </div>
            <div className="input">
              <CheckboxSetting
                ...
                tooltip={i18n(
                  "settings.interface.behavior.clear_tracklist_tooltip"
                )}
              />
              <CheckboxSetting
              ...
              <CheckboxSetting
                ...
                tooltip={i18n(
                  "settings.interface.behavior.touch_events_tooltip"
                )}
              />
              <CheckboxSetting
          ...
          <div className="field checkbox">
            <div className="name">
              <I18n path="settings.interface.scrolling.label" />
            </div>
            <div className="input">
              <CheckboxSetting
            ...
            <div className="field checkbox">
              ...
              <div className="input">
                ...
                <div className="description">
                  ...
                  <a
                    href="https://github.com/jaedb/Iris/wiki/Terms-of-use#privacy-policy"
                    target="_blank"
                  >
          ...
          <div className="field">
            ...
            <div className="input">
              <TextField
                ...
                onChange={(value) =>
                  this.onMopidySettingChanged(
                    "mopidy_library_artists_uri",
                    value
                  )
                }
                autosave
              ...
              <span className="text">
                ...
                <span className="mid_grey-text tooltip">
                  ...
                  {window.build && (
                    <span className="tooltip__content">
                      <Dater
                        data={parseInt(window.build, 10) * 1000}
                        type="ago"
                      />
                      {" ago"}
                    </span>
                ...
                {pusher.version.upgrade_available ? (
                  <>
                    ...
                    <Button
                      ...
                      tracking={{
                        category: "System",
                        action: "Upgrade",
                        label: pusher.version.latest,
                      }}
                    >
                      <I18n
                        path="settings.advanced.version.upgrade"
                        version={pusher.version.latest}
                      />
                    </Button>
                  </>
                  ...
                  <span className="flag flag--dark">
                    ...
                    <I18n path="settings.advanced.version.up_to_date"> </I18n>
                  </span>
                )}
              </span>
            </div>
          ...
          <div className="field">
            ...
            <Button to="/modal/reset" type="destructive">
          ...
          <div>
            ...
            <Button
              href="https://soundfood.it"
              target="_blank"
              tracking={{ category: "About", action: "Company" }}
            >
              <I18n path="settings.about.sponsor">
                <Icon type="fontawesome" name="fa-solid fa-building" />{" "}
              </I18n>
            </Button>
          </div>
        </section>
